...
import net.tech.testmod.item.custom.FuelItem;
import net.tech.testmod.item.custom.ExplodingCarLauncherItem;
import net.tech.testmod.item.custom.MetalDetectorItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> EXPLODING_CAR_LAUNCHER= ITEMS.register("exploding_car_launcher", ()-> new ExplodingCarLauncherItem(new Item.Properties().durability(100)));
